...
import com.readystatesoftware.chuck2.internal.data.LocalCupboard;
import com.readystatesoftware.chuck2.internal.support.NotificationHelper;
import com.readystatesoftware.chuck2.internal.support.RetentionManager;
import com.readystatesoftware.chuck2.internal.ui.MainActivity;
...
public final class ChuckInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (filterUrlPattern != null && !filterUrlPattern.isEmpty()) {
            ...
            if (contains && !"PUT".equals(request.method())) {
                return chain.proceed(request);
            }
        }
        ...
        if (hasRequestBody) {
            ...
            if (isRequestBodyImg) {
                try {
                    File dir = new File(app.getExternalCacheDir(), "chuckimgcache");
                    if (!dir.exists()) {
                        dir.mkdirs();
                    }
                    ...
                    transaction.setRequestBody(exif);
                } catch (Throwable throwable) {
                    throwable.printStackTrace();
                }

            } else if (transaction.requestBodyIsPlainText()) {
